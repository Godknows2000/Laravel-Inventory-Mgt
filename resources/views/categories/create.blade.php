...
<div class="max-w-5xl mx-auto p-3 mt-22 md:w-8/12">
    <div class="card bg-white shadow-md rounded-lg">
        ...
        <h1 class="text-xl font-semibold text-center">Create Category</h1>
            <x-splade-form :action="route('categories.store')" class="justify-center w-full px-5 py-5 mx-auto space-y-4 bg-white md:w-4/12">
