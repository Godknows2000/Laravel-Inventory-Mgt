<x-layout>
    <x-splade-form :action="route('students.store')" class="justify-center w-full px-5 py-5 mx-auto mt-16 space-y-4 bg-white md:w-6/12">
        <h1 class="text-xl font-semibold text-center">Create Student/Customer</h1>
